...
class OpenFile {
  public:
	...
	//type =2 socket
	//tyep =1 read
	//type =0 std read/write
	//char*filename; //luuw teen file
	bool isConnect;

    OpenFile(int f) { file = f; currentOffset = 0; isConnect = true;}	// open the file
...
class socketH : public OpenFile {
public:
	socketH(int f) : OpenFile(f,2)  {
	}
